...
/*    public void setUp() {
    ...
    public void reTweetFollowingTest() {
        ...
        Assert.assertNotNull(elem, "ERROR: retweet not found on my page");
...
/*        Reporter.log("-->retweet count BEFORE: " + retweetBeforeCount);
    ...
    @Test(dependsOnMethods = {"reTweetFollowingTest"}, alwaysRun = true, description = "test ry to logout from site")
